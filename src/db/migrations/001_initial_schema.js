    ...
    return knex.schema
        ...
        .createTable("games", (table) => {
            ...
            table.integer("home_rushing_yards")
                .defaultTo(0);
            table.integer("home_rushing_tds")
                .defaultTo(0);
            table.integer("home_passing_attempts")
                .defaultTo(0);
            table.integer("home_passing_completions")
                .defaultTo(0);
            table.integer("home_passing_yards")
                .defaultTo(0);
            table.integer("home_passing_tds")
                .defaultTo(0);
            table.integer("home_interceptions_thrown")
                .defaultTo(0);
            table.integer("home_receptions")
                .defaultTo(0);
            table.integer("home_receiving_yards")
                .defaultTo(0);
            table.integer("home_receiving_tds")
                .defaultTo(0);
            table.integer("home_sacks")
                .defaultTo(0);
            table.integer("home_interceptions")
                .defaultTo(0);
            table.integer("home_interception_return_yards")
                .defaultTo(0);
            table.integer("home_interception_return_tds")
                .defaultTo(0);
            table.integer("home_kick_return_yards")
                .defaultTo(0);
            table.integer("home_kick_return_tds")
                .defaultTo(0);
            table.integer("home_punt_return_yards")
                .defaultTo(0);
            table.integer("home_punt_return_tds")
                .defaultTo(0);
            table.integer("home_punts")
                .defaultTo(0);
            table.integer("home_punt_yards")
                .defaultTo(0);
            table.integer("home_xp_attempts")
                .defaultTo(0);
            table.integer("home_xp_made")
                .defaultTo(0);
            table.integer("home_fg_attempts")
                .defaultTo(0);
            table.integer("home_fg_made")
                .defaultTo(0);
            table.integer("home_tracked_pts")
                .defaultTo(0);
            table.integer("home_untracked_pts")
                .defaultTo(0);
            ...
            table.integer("away_rushing_yards")
                .defaultTo(0);
            table.integer("away_rushing_tds")
                .defaultTo(0);
            table.integer("away_passing_attempts")
                .defaultTo(0);
            table.integer("away_passing_completions")
                .defaultTo(0);
            table.integer("away_passing_yards")
                .defaultTo(0);
            table.integer("away_passing_tds")
                .defaultTo(0);
            table.integer("away_interceptions_thrown")
                .defaultTo(0);
            table.integer("away_receptions")
                .defaultTo(0);
            table.integer("away_receiving_yards")
                .defaultTo(0);
            table.integer("away_receiving_tds")
                .defaultTo(0);
            table.integer("away_sacks")
                .defaultTo(0);
            table.integer("away_interceptions")
                .defaultTo(0);
            table.integer("away_interception_return_yards")
                .defaultTo(0);
            table.integer("away_interception_return_tds")
                .defaultTo(0);
            table.integer("away_kick_return_yards")
                .defaultTo(0);
            table.integer("away_kick_return_tds")
                .defaultTo(0);
            table.integer("away_punt_return_yards")
                .defaultTo(0);
            table.integer("away_punt_return_tds")
                .defaultTo(0);
            table.integer("away_punts")
                .defaultTo(0);
            table.integer("away_punt_yards")
                .defaultTo(0);
            table.integer("away_xp_attempts")
                .defaultTo(0);
            table.integer("away_xp_made")
                .defaultTo(0);
            table.integer("away_fg_attempts")
                .defaultTo(0);
            table.integer("away_fg_made")
                .defaultTo(0);
            table.integer("away_tracked_pts")
                .defaultTo(0);
            table.integer("away_untracked_pts")
                .defaultTo(0);

            // Pre-game records
            table.integer("home_pre_wins")
                .defaultTo(0);
            table.integer("home_pre_losses")
                .defaultTo(0);
            table.integer("home_pre_ties")
                .defaultTo(0);
            table.integer("home_pre_points_for")
                .defaultTo(0);
            table.integer("home_pre_points_against")
                .defaultTo(0);
            table.integer("away_pre_wins")
                .defaultTo(0);
            table.integer("away_pre_losses")
                .defaultTo(0);
            table.integer("away_pre_ties")
                .defaultTo(0);
            table.integer("away_pre_points_for")
                .defaultTo(0);
            table.integer("away_pre_points_against")
                .defaultTo(0);
        ...
        .createTable("player_game_stats", (table) => {
            ...
            table.integer("kick_return_attempts")
                .defaultTo(0);
            table.integer("kick_return_yards")
                .defaultTo(0);
            table.integer("kick_return_tds")
                .defaultTo(0);
            table.integer("punt_return_attempts")
                .defaultTo(0);
            ...
            table.integer("interception_return_yards")
                .defaultTo(0);
            table.integer("interception_return_tds")
                .defaultTo(0);

            // Kicking
            table.integer("xp_attempts")
                .defaultTo(0);
            table.integer("xp_made")
                .defaultTo(0);
            table.integer("fg_attempts")
                .defaultTo(0);
            table.integer("fg_made")
                .defaultTo(0);
